...
export const SectionAbout = () => {
    return (
        <div className="panel-section section2 row align-items-center" id="about">
            ...
            <p> Hola que tal! soy Johans, desarrollador de software asentado en la ciudad
                 de Villa Alemana, Región de Valparaíso, Chile.
            </p>
            <p> Hoy en día me encuentro cursando mi último año en la carrera de Ingeniería en Informática donde a través de estos años he podido acumular gran conocimiento
                 en el área de la tecnología e informática, realizando proyectos tanto pedagógicos de tipo interno, como particulares de tipo externo. Actualmente también desempeño labores como desarrollador de software para Evalueserve Chile desde Julio de 2021
                 <br></br>
